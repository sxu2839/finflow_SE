...
public class ReminderDatabase extends SQLiteOpenHelper {
    ...
    public int addReminder(Reminder reminder){
        ...
        db.close();
        Log.d(TAG, "Reminder added with ID: " + ID);
        return (int) ID;
    }
    ...
    public List<Reminder> getAllReminders(){
        ...
        Log.d("ReminderDatabase", "Number of reminders retrieved: " + reminderList.size());
        return reminderList;
    }
    ...
    public int getRemindersCount(){
        ...
        Log.d(TAG, "Reminders count: " + count);
        return count;
    }
    ...
    public int updateReminder(Reminder reminder){
        ...
        // Updating row
        int rowsAffected = db.update(TABLE_REMINDERS, values, KEY_ID + "=?",
    ...
    public void deleteReminder(Reminder reminder){
        ...
        db.delete(TABLE_REMINDERS, KEY_ID + "=?",
                new String[]{String.valueOf(reminder.getID())});
        db.close();
        Log.d(TAG, "Reminder deleted with ID: " + reminder.getID());
    }
}
